...
//    CGContextSetFillColorWithColor(context, [[UIColor blackColor] CGColor]);
    ...
    [info_ drawInRect:r withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:kLJInfoAlert_fontSize],  NSForegroundColorAttributeName:kLJInfoAlert_FontColor}];
}
-(void)dealloc
{
